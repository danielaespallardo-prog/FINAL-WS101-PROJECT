...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        var products = List.of(
            ...
            new Product(null, "Brass Decorative Plate", 280.00, "Intricately engraved brass plate from Zamboanga artisans.", "Engraved.", "Zamboanga Artisans", "Zamboanga, PH", "Decor", true, "images/oip/OIP.jpg"),
            ...
            new Product(null, "T'boli Beaded Necklace", 520.00, "Indigenous T'boli tribal beaded necklace with traditional patterns.", "Beaded.", "T'boli Artisans", "South Cotabato, PH", "Jewelry", true, "images/oip/OIP.jpg"),
            ...
            new Product(null, "Coconut Shell Bowls", 245.00, "Eco-friendly bowls handcrafted from natural coconut shells.", "Eco.", "Coco", "Palawan, PH", "Kitchenware", true, "images/oip/OIP.jpg"),
            ...
            new Product(null, "Inlaid Mother of Pearl Box", 650.00, "Ornate wooden box with mother of pearl inlay from Iloilo.", "Inlaid.", "Iloilo Crafts", "Iloilo, PH", "Decor", true, "images/oip/OIP.jpg")
        );
